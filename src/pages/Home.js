  ...
  return (
    <div className="">
      <div className="imgContainer">
        <img src="./teacher.jpg" className="HomeImg wrapper" alt="HomeIcon"></img>
        <div className="imgOverlayer overlayer">
          ...
          <h5 className="responsiveText3">
            Fully credentialed including Special Ed.
          </h5>
        </div>
      </div>
      ...
      <div className="classesBox">
        ...
        <Link href="/classes">
          <button id="button" href="/classes">
            Learn More
          </button>
        </Link>
        <Link href="/contact">
          <button id="button">Contact Me to Register</button>
        </Link>
      </div>
      ...
      <div className="classesBox">
        ...
        {/*
                ...
                */}
        <h3 className="">
          Tutoring offered in multiple subjects and grade levels.
        </h3>
        <br />
        <Link href="/tutoring">
        ...
        <Link href="/contact">
          <button id="button">Contact Me for Availability</button>
        </Link>
      </div>
      ...
      <div className="HomeDisplay">
        <span>
          ...
          <Link href="/about">
            <img src="education.png" alt="educationIcon"></img>
          </Link>
        ...
        <span>
          ...
          <Link>
            <img src="curriculum.png" alt="curriculumIcon"></img>
          </Link>
        ...
        <span>
          ...
          <Link href="/contact">
            <img src="contact.png" alt="contactIcon"></img>
          </Link>
